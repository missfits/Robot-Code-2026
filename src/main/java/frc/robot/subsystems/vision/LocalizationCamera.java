...
public class LocalizationCamera {
  ...
  public static record CameraReading(String cameraName, EstimatedRobotPose robotPose, Optional<EstimatedRobotPose> alternatePose, Matrix<N3, N1> stdDevs, double timestampSeconds, int numTargets) {}
