...
public class TunerConstants {
    ...
    private static final TalonFXConfiguration driveInitialConfigs = new TalonFXConfiguration()
        .withCurrentLimits(
            new CurrentLimitsConfigs()
                .withStatorCurrentLimit(Amps.of(Constants.DrivetrainConstants.DRIVE_STATOR_CURRENT_LIMIT))
                .withStatorCurrentLimitEnable(true)
                .withSupplyCurrentLimit(Constants.DrivetrainConstants.DRIVE_SUPPLY_CURRENT_LIMIT)
    ...
    private static final TalonFXConfiguration steerInitialConfigs = new TalonFXConfiguration()
        .withCurrentLimits(
            new CurrentLimitsConfigs()
                ...
                .withStatorCurrentLimit(Amps.of(Constants.DrivetrainConstants.STEER_STATOR_CURRENT_LIMIT))
                .withStatorCurrentLimitEnable(true)
                .withSupplyCurrentLimit(Constants.DrivetrainConstants.STEER_SUPPLY_CURRENT_LIMIT)
                .withSupplyCurrentLimitEnable(true)
        );
    ...
    public static CommandSwerveDrivetrain createDrivetrain() {
        if (Utils.isSimulation()){
            // Regulate module constants for simulation to fix inversions and encoder offsets
            MapleSimSwervePhysics.regulateModuleConstantsForSimulation(
                new SwerveModuleConstants<?, ?, ?>[] { FrontLeft, FrontRight, BackLeft, BackRight }
            );
            return new CommandSwerveDrivetrainSim(
